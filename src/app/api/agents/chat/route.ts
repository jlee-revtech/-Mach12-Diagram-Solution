...
const TOOL_LABELS: Record<string, string> = {
  ...
  list_diagrams: 'Reading your data-architecture diagrams',
  get_diagram: 'Reading a data-architecture diagram in detail',
  find_data_flows: 'Searching your data flows across every diagram',
