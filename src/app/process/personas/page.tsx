          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[var(--m12-text-secondary)] text-base font-medium">Persona Catalog</span>
                <span className="self-end mb-0.5"><VersionBadge /></span>
              </div>
              <p className="text-xs text-[var(--m12-text-muted)] mt-0.5">
                Personas are made up of roles (many-to-many). A role can be instantiated as a swimlane in a process model.
              </p>
            </div>
          </div>
        </div>
