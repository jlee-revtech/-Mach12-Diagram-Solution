...
export const STANDARD_WORKSTREAMS: StandardWorkstreamDef[] = [
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'dassian-labor-costing-alc', 'sap-ad-commercial-defense-structure', 'dassian-results-analysis', 'dassian-cost-management', 'sap-cats-time-recording', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-cas-in-sap', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'dassian-project-management', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'],
  ...
  },
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-plm-design-to-release-ad', 'vibe-sap-recipes', 'sap-rap-development'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-pp-capacity-planning', 'sap-ad-commercial-defense-structure', 'sap-data-load-so-to-ps', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-mmas', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-ad-commercial-defense-structure', 'sap-data-load-so-to-ps', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-mmas', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-government-property-a2r', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-ad-depot-mro', 'vibe-sap-recipes', 'sap-rap-development'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'dassian-contracts', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'dassian-contracts', 'dassian-cost-management', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-pricing-tina', 'govcon-cas-in-sap', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'dassian-labor-costing-alc', 'govcon-timekeeping-compliance', 'sap-cats-time-recording', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness'],
  ...
  // ─── Cross-cutting platform agents (serve every value stream) ─
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-ad-security-itar', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-ad-program-analytics', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-rap-development', 'vibe-sap-recipes', 'vibe-update-class-include'],
