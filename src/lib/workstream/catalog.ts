...
export const STANDARD_WORKSTREAMS: StandardWorkstreamDef[] = [
  ...
  },
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-rap-development', 'vibe-sap-recipes', 'vibe-update-class-include', 'dassian-installation'],
