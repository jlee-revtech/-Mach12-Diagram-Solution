...
export const STANDARD_WORKSTREAMS: StandardWorkstreamDef[] = [
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-labor-costing-alc', 'sap-ad-commercial-defense-structure', 'dassian-results-analysis', 'dassian-cost-management', 'sap-cats-time-recording', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-cas-in-sap', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-project-management', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-government-property-a2r', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'],
  ...
  // ─── Cross-cutting platform agents (serve every value stream) ─
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-security-itar', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-program-analytics', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'],
  ...
  },
  {
    ...
    dassianModules: [],
    knowledgeSourceCodes: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-rap-development', 'vibe-sap-recipes', 'vibe-update-class-include'],
