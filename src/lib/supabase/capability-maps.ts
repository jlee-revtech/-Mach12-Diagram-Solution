...
export async function updateCapabilityInput(
  id: string,
  updates: Partial<Pick<CapabilityInput, 'supplier_persona_ids' | 'source_system_ids' | 'sort_order'>>
): Promise<void> {
...
export async function updateCapabilityOutput(
  id: string,
  updates: Partial<Pick<CapabilityOutput, 'consumer_persona_ids' | 'sort_order'>>
): Promise<void> {
