...
// Canonical taxonomy = SAP Solution Studio config roster: 7 A&D value streams +
...
const WORKSTREAMS = [
  { code: 'record-to-report', name: 'Record-to-Report (Finance / EVMS / DCAA)', description: 'End-to-end financial accounting and reporting: GL, assets, cost, indirect rates, settlement, revenue recognition, and close.', tagline: 'GL, costing, rates, and rev-rec consultant', sapModules: ['FI-GL', 'FI-AA', 'CO-CCA', 'CO-PA', 'CO-PC', 'PS settlement', 'Group Reporting'], dassianModules: ['Cost Management (OH, costing sheets, FR)', 'Results Analysis (RAENH rev-rec)'], skills: ['dassian-results-analysis', 'dassian-cost-management', 'vibe-sap-recipes'], sort: 1 },
  { code: 'plan-to-perform', name: 'Plan-to-Perform (Program & Portfolio Management)', description: 'EVMS-grade program and portfolio management: baseline, control accounts, work authorization, EAC/ETC, risk, and variance reporting.', tagline: 'EVMS, PMB, and EAC/ETC program-control consultant', sapModules: ['PS', 'PPM', 'CO', 'Group Reporting'], dassianModules: ['Project Mgmt (PPC, EVM, CAM, EAC/ETC, IPMR/533)'], skills: ['dassian-project-management', 'vibe-sap-recipes'], sort: 2 },
  { code: 'plan-to-produce', name: 'Plan-to-Produce (Engineering & Program Execution)', description: 'Engineering and configuration management through production planning, MRP, shop-floor execution, and quality.', tagline: 'PLM, MRP, shop-floor, and quality consultant', sapModules: ['PP', 'PP-MRP', 'QM', 'LO-VC', 'PLM / ECM', 'PP-BOM', 'PS', 'MM-IM'], dassianModules: ['Project Mgmt (EVM)', 'MPIA / BOM cost'], skills: ['sap-data-load-so-to-ps', 'vibe-sap-recipes'], sort: 3 },
  { code: 'inventory-to-deliver', name: 'Inventory-to-Deliver (Logistics, Property & Sustainment)', description: 'Materials management, warehousing, deliveries, government/contractor property accountability, and depot/field sustainment (MRO).', tagline: 'Logistics, GFP property, and MRO consultant', sapModules: ['MM-IM', 'WM / EWM', 'LE (deliveries)', 'Handling Units', 'Batch / Serial', 'PM / EAM', 'FI-AA (property)'], dassianModules: ['DD250 / ABS', 'GFP / property accountability'], skills: ['sap-data-load-so-to-ps', 'vibe-sap-recipes'], sort: 4 },
  { code: 'source-to-pay', name: 'Source-to-Pay (Procurement & Subcontracts)', description: 'Supplier management, sourcing, subcontracting with FAR/DFARS flowdowns, and procure-to-pay.', tagline: 'Subcontracts, flowdowns, and P2P consultant', sapModules: ['MM', 'MM-PUR', 'MDG-S', 'Subcontracting', 'MM-IV', 'Ariba', 'FI-AP'], dassianModules: ['SCFM', 'Contracts (flowdowns, clause library)', 'PBP'], skills: ['dassian-contracts', 'vibe-sap-recipes'], sort: 5 },
  { code: 'offer-to-cash', name: 'Offer-to-Cash (Capture, Contracts, Billing & Rev-Rec)', description: 'Sell-side lifecycle from capture and proposal through contract setup, CLIN/SLIN billing, deliveries acceptance, and revenue recognition.', tagline: 'Capture, contracts, billing, and rev-rec consultant', sapModules: ['SD', 'SD-BIL', 'RAR', 'DP90', 'PS'], dassianModules: ['Contracts (CLIN/SLIN/ACRN, mods, DD250)', 'PBP', 'Billing (BIL / DRB)', 'ABS', 'Results Analysis (RAENH)'], skills: ['dassian-contracts', 'dassian-cost-management', 'vibe-sap-recipes'], sort: 6 },
  { code: 'hire-to-retire', name: 'Hire-to-Retire (Workforce / Clearances)', description: 'Workforce lifecycle: talent and clearances, records, compliant timekeeping, payroll, labor distribution, and offboarding.', tagline: 'Clearances, compliant timekeeping, and payroll consultant', sapModules: ['HCM / SF', 'PT (time)', 'PY (payroll)', 'CATS'], dassianModules: ['Labor / role-based costing', 'CATS approval'], skills: ['vibe-sap-recipes'], sort: 7 },
  { code: 'security-authorization', name: 'Security & Authorization', description: 'Cross-stream role design, authorizations, segregation-of-duties, and access governance.', tagline: 'Roles, authorizations, and SoD consultant', sapModules: ['GRC', 'PFCG', 'SU24', 'IAG / IAM'], dassianModules: [], skills: ['vibe-sap-recipes'], sort: 8 },
  { code: 'analytics-reporting', name: 'Analytics & Reporting', description: 'Cross-stream embedded analytics, operational and management reporting, and planning.', tagline: 'Embedded analytics and reporting consultant', sapModules: ['Embedded Analytics', 'CDS analytical', 'SAC', 'Datasphere'], dassianModules: ['GPD / PACE reporting'], skills: ['vibe-sap-recipes'], sort: 9 },
  { code: 'development-technology', name: 'Development & Technology', description: 'Cross-stream RICEFW, RAP extensions, CDS modeling, integration, and clean-core engineering.', tagline: 'RICEFW, extensions, and clean-core consultant', sapModules: ['ABAP / RAP', 'BTP', 'CDS', 'Gateway / OData'], dassianModules: [], skills: ['vibe-sap-recipes', 'vibe-update-class-include'], sort: 10 },
]
...
const ENTERPRISE_PERSONA = `You are the enterprise solution architect orchestrating a team of world-class SAP S/4HANA + Dassian A&D workstream consultants. The seven value-stream consultants are Record-to-Report, Plan-to-Perform, Plan-to-Produce, Inventory-to-Deliver, Source-to-Pay, Offer-to-Cash, and Hire-to-Retire; three cross-cutting platform consultants cover Security & Authorization, Analytics & Reporting, and Development & Technology.
