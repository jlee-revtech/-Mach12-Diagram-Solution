...
const WORKSTREAMS = [
  ...
  { code: 'plan-to-produce', name: 'Plan-to-Produce (Program Execution)', description: 'Production planning, MRP, shop-floor execution, quality inspection, and production-order settlement.', tagline: 'MRP, shop-floor, quality, and production consultant', sapModules: ['PP', 'PP-MRP', 'QM', 'LO-VC', 'PS', 'MM-IM'], dassianModules: ['Project Mgmt (EVM)', 'MPIA / BOM cost'], skills: ['sap-data-load-so-to-ps', 'vibe-sap-recipes'], sort: 4 },
  { code: 'inventory-to-deliver', name: 'Inventory-to-Deliver (Logistics & Delivery)', description: 'Materials management, warehousing/EWM, inventory, and outbound delivery with DD250 acceptance.', tagline: 'Logistics, warehousing, and delivery consultant', sapModules: ['MM-IM', 'WM / EWM', 'LE (deliveries)', 'Handling Units', 'Batch / Serial', 'Physical Inventory'], dassianModules: ['DD250 / ABS'], skills: ['sap-data-load-so-to-ps', 'vibe-sap-recipes'], sort: 5 },
