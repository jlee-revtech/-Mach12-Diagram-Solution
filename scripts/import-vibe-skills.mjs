...
const WORKSTREAMS = [
  ...
  { code: 'development-technology', name: 'Development & Technology', description: 'Cross-stream RICEFW, RAP extensions, CDS modeling, integration, and clean-core engineering.', tagline: 'RICEFW, extensions, and clean-core consultant', sapModules: ['ABAP / RAP', 'BTP', 'CDS', 'Gateway / OData'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-rap-development', 'vibe-sap-recipes', 'vibe-update-class-include'], sort: 13 },
]
