...
const WORKSTREAMS = [
  ...
  { code: 'offer-to-cash', name: 'Offer-to-Cash (Capture, Contracts, Billing & Rev-Rec)', description: 'Sell-side lifecycle from capture and proposal through contract setup, CLIN/SLIN billing, deliveries acceptance, and revenue recognition.', tagline: 'Capture, contracts, billing, and rev-rec consultant', sapModules: ['SD', 'SD-BIL', 'RAR', 'DP90', 'PS'], dassianModules: ['Contracts (CLIN/SLIN/ACRN, mods, DD250)', 'PBP', 'Billing (BIL / DRB)', 'ABS', 'Results Analysis (RAENH)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-contracts', 'dassian-cost-management', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-pricing-tina', 'govcon-cas-in-sap', 'govcon-dfars-business-systems'], sort: 9 },
