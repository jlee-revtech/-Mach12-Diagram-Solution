...
const WORKSTREAMS = [
  { code: 'record-to-report', name: 'Record-to-Report (Finance / DCAA)', description: 'End-to-end financial accounting and reporting: GL, assets, cost, indirect rates, settlement, revenue recognition, and close.', tagline: 'GL, costing, rates, and rev-rec consultant', sapModules: ['FI-GL', 'FI-AA', 'CO-CCA', 'CO-PA', 'CO-PC', 'PS settlement', 'Group Reporting'], dassianModules: ['Cost Management (OH, costing sheets, FR)', 'Results Analysis (RAENH rev-rec)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-labor-costing-alc', 'sap-ad-commercial-defense-structure', 'dassian-results-analysis', 'dassian-cost-management', 'dassian-overhead-springboard', 'sap-cats-time-recording', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-cas-in-sap', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'], crossStream: 'Earned Value Management (EVMS) is owned by the Plan-to-Perform program-control consultant, not by you. Your role is to FULFILL the EVM data dependencies Plan-to-Perform specifies: actual cost of work performed (ACWP) from cost postings / ACDOCA, cost-element and settlement actuals, and the indirect/burden rates that feed the cost baseline. Provide these as the financial system of record and defer EVM methodology, the PMB, control accounts, EAC/ETC, and IPMR/533 reporting to Plan-to-Perform.', sort: 1 },
  { code: 'plan-to-perform', name: 'Plan-to-Perform (Program & Portfolio Management)', description: 'EVMS-grade program and portfolio management: baseline, control accounts, work authorization, EAC/ETC, risk, and variance reporting.', tagline: 'EVMS, PMB, and EAC/ETC program-control consultant', sapModules: ['PS', 'PPM', 'CO', 'Group Reporting'], dassianModules: ['Project Mgmt (PPC, EVM, CAM, EAC/ETC, IPMR/533)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-project-management', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'], crossStream: 'You OWN Earned Value Management (EVMS): the performance measurement baseline (PMB), control accounts and CAM assignment, work authorization, BCWS/BCWP/ACWP, CPI/SPI, EAC/ETC, and IPMR/533 (CPR) reporting. You SPECIFY the cost and actuals dependencies that Record-to-Report fulfills (actual costs / ACWP, cost-element actuals, indirect and burden rates). Consume those as authoritative inputs and reconcile earned value to the financial actuals RTR provides rather than re-deriving them.', sort: 2 },
  { code: 'design-to-release', name: 'Design-to-Release (Engineering / PLM)', description: 'Requirements through design, configuration management, engineering change, and BOM release with first article inspection.', tagline: 'Requirements, CM, and BOM-release consultant', sapModules: ['PLM', 'PP-BOM', 'ECM (engineering change)', 'QM (FAI)'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-plm-design-to-release-ad', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development'], sort: 3 },
  { code: 'plan-to-produce', name: 'Plan-to-Produce (Program Execution)', description: 'Production planning, MRP, capacity planning, shop-floor execution, quality inspection, and production-order settlement.', tagline: 'MRP, capacity, shop-floor, quality, and production consultant', sapModules: ['PP', 'PP-MRP', 'PP-CRP (capacity)', 'PP/DS', 'QM', 'LO-VC', 'PS', 'MM-IM'], dassianModules: ['Project Mgmt (EVM)', 'MPIA / BOM cost'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-pp-capacity-planning', 'sap-aatp-order-promising', 'sap-ad-commercial-defense-structure', 'sap-data-load-so-to-ps', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-mmas', 'govcon-dfars-business-systems'], sort: 4 },
  { code: 'inventory-to-deliver', name: 'Inventory-to-Deliver (Logistics & Delivery)', description: 'Materials management, warehousing/EWM, inventory, and outbound delivery with DD250 acceptance.', tagline: 'Logistics, warehousing, and delivery consultant', sapModules: ['MM-IM', 'WM / EWM', 'LE (deliveries)', 'Handling Units', 'Batch / Serial', 'Physical Inventory'], dassianModules: ['DD250 / ABS'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-commercial-defense-structure', 'sap-data-load-so-to-ps', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-mmas', 'govcon-dfars-business-systems'], sort: 5 },
  { code: 'acquire-to-retire', name: 'Acquire-to-Retire (Asset / Property / GFP)', description: 'Government and contractor property accountability and fixed-asset lifecycle from acquisition through disposition.', tagline: 'GFP/CAP property and fixed-asset consultant', sapModules: ['FI-AA', 'MM-IM', 'PS'], dassianModules: ['GFP / property accountability'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-government-property-a2r', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'], sort: 6 },
  { code: 'sustainment-mro', name: 'Sustainment / MRO', description: 'Depot and field maintenance, repair, and overhaul with installed-base and warranty management.', tagline: 'Depot/field MRO and installed-base consultant', sapModules: ['PM / EAM', 'CS', 'PP (refurb)', 'MM'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-depot-mro', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development'], sort: 7 },
  { code: 'source-to-pay', name: 'Source-to-Pay (Procurement & Subcontracts)', description: 'Supplier management, sourcing, subcontracting with FAR/DFARS flowdowns, and procure-to-pay.', tagline: 'Subcontracts, flowdowns, and P2P consultant', sapModules: ['MM', 'MM-PUR', 'MDG-S', 'Subcontracting', 'MM-IV', 'Ariba', 'FI-AP'], dassianModules: ['SCFM', 'Contracts (flowdowns, clause library)', 'PBP'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-contracts', 'sap-bp-customer-vendor-create', 'sap-ad-commercial-defense-structure', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'], sort: 8 },
  { code: 'offer-to-cash', name: 'Offer-to-Cash (Capture, Contracts, Billing & Rev-Rec)', description: 'Sell-side lifecycle from capture and proposal through contract setup, CLIN/SLIN billing, deliveries acceptance, and revenue recognition.', tagline: 'Capture, contracts, billing, and rev-rec consultant', sapModules: ['SD', 'SD-BIL', 'RAR', 'DP90', 'PS'], dassianModules: ['Contracts (CLIN/SLIN/ACRN, mods, DD250)', 'PBP', 'Billing (BIL / DRB)', 'ABS', 'Results Analysis (RAENH)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-contracts', 'dassian-cost-management', 'mach12-contract-studio-sync', 'sap-aatp-order-promising', 'sap-bp-customer-vendor-create', 'sap-ad-commercial-defense-structure', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-pricing-tina', 'govcon-cas-in-sap', 'govcon-dfars-business-systems'], sort: 9 },
  { code: 'hire-to-retire', name: 'Hire-to-Retire (Workforce / Clearances)', description: 'Workforce lifecycle: talent and clearances, records, compliant timekeeping, payroll, labor distribution, and offboarding.', tagline: 'Clearances, compliant timekeeping, and payroll consultant', sapModules: ['HCM / SF', 'PT (time)', 'PY (payroll)', 'CATS'], dassianModules: ['Labor / role-based costing', 'CATS approval'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-labor-costing-alc', 'govcon-timekeeping-compliance', 'sap-cats-time-recording', 'sap-mro-repair-lifecycle', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness'], sort: 10 },
  { code: 'security-authorization', name: 'Security & Authorization', description: 'Cross-stream role design, authorizations, segregation-of-duties, and access governance.', tagline: 'Roles, authorizations, and SoD consultant', sapModules: ['GRC', 'PFCG', 'SU24', 'IAG / IAM'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-security-itar', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems'], sort: 11 },
  { code: 'analytics-reporting', name: 'Analytics & Reporting', description: 'Cross-stream embedded analytics, operational and management reporting, and planning.', tagline: 'Embedded analytics and reporting consultant', sapModules: ['Embedded Analytics', 'CDS analytical', 'SAC', 'Datasphere'], dassianModules: ['GPD / PACE reporting'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-program-analytics', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'], sort: 12 },
  { code: 'development-technology', name: 'Development & Technology', description: 'Cross-stream RICEFW, RAP extensions, CDS modeling, integration, and clean-core engineering.', tagline: 'RICEFW, extensions, and clean-core consultant', sapModules: ['ABAP / RAP', 'BTP', 'CDS', 'Gateway / OData'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-rap-development', 'vibe-sap-recipes', 'vibe-update-class-include', 'dassian-installation'], sort: 13 },
]
