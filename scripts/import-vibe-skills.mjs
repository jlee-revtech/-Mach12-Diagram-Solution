...
const WORKSTREAMS = [
  { code: 'record-to-report', name: 'Record-to-Report (Finance / DCAA)', description: 'End-to-end financial accounting and reporting: GL, assets, cost, indirect rates, settlement, revenue recognition, and close.', tagline: 'GL, costing, rates, and rev-rec consultant', sapModules: ['FI-GL', 'FI-AA', 'CO-CCA', 'CO-PA', 'CO-PC', 'PS settlement', 'Group Reporting'], dassianModules: ['Cost Management (OH, costing sheets, FR)', 'Results Analysis (RAENH rev-rec)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-labor-costing-alc', 'sap-ad-commercial-defense-structure', 'dassian-results-analysis', 'dassian-cost-management', 'dassian-overhead-springboard', 'sap-cats-time-recording', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-cas-in-sap', 'govcon-dcaa-audit-readiness', 'govcon-dfars-business-systems'], crossStream: 'Earned Value Management (EVMS) is owned by the Plan-to-Perform program-control consultant, not by you. Your role is to FULFILL the EVM data dependencies Plan-to-Perform specifies: actual cost of work performed (ACWP) from cost postings / ACDOCA, cost-element and settlement actuals, and the indirect/burden rates that feed the cost baseline. Provide these as the financial system of record and defer EVM methodology, the PMB, control accounts, EAC/ETC, and IPMR/533 reporting to Plan-to-Perform.', sort: 1 },
  ...
  { code: 'sustainment-mro', name: 'Sustainment / MRO', description: 'Depot and field maintenance, repair, and overhaul with installed-base and warranty management.', tagline: 'Depot/field MRO and installed-base consultant', sapModules: ['PM / EAM', 'CS', 'PP (refurb)', 'MM'], dassianModules: [], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','sap-ad-depot-mro', 'vibe-sap-recipes', 'sap-rap-development'], sort: 7 },
  { code: 'source-to-pay', name: 'Source-to-Pay (Procurement & Subcontracts)', description: 'Supplier management, sourcing, subcontracting with FAR/DFARS flowdowns, and procure-to-pay.', tagline: 'Subcontracts, flowdowns, and P2P consultant', sapModules: ['MM', 'MM-PUR', 'MDG-S', 'Subcontracting', 'MM-IV', 'Ariba', 'FI-AP'], dassianModules: ['SCFM', 'Contracts (flowdowns, clause library)', 'PBP'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-contracts', 'sap-bp-customer-vendor-create', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dfars-business-systems', 'govcon-pricing-tina'], sort: 8 },
  { code: 'offer-to-cash', name: 'Offer-to-Cash (Capture, Contracts, Billing & Rev-Rec)', description: 'Sell-side lifecycle from capture and proposal through contract setup, CLIN/SLIN billing, deliveries acceptance, and revenue recognition.', tagline: 'Capture, contracts, billing, and rev-rec consultant', sapModules: ['SD', 'SD-BIL', 'RAR', 'DP90', 'PS'], dassianModules: ['Contracts (CLIN/SLIN/ACRN, mods, DD250)', 'PBP', 'Billing (BIL / DRB)', 'ABS', 'Results Analysis (RAENH)'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-contracts', 'dassian-cost-management', 'mach12-contract-studio-sync', 'sap-aatp-order-promising', 'sap-bp-customer-vendor-create', 'sap-ad-commercial-defense-structure', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-pricing-tina', 'govcon-cas-in-sap', 'govcon-dfars-business-systems'], sort: 9 },
  { code: 'hire-to-retire', name: 'Hire-to-Retire (Workforce / Clearances)', description: 'Workforce lifecycle: talent and clearances, records, compliant timekeeping, payroll, labor distribution, and offboarding.', tagline: 'Clearances, compliant timekeeping, and payroll consultant', sapModules: ['HCM / SF', 'PT (time)', 'PY (payroll)', 'CATS'], dassianModules: ['Labor / role-based costing', 'CATS approval'], skills: ['sap-transport-request-management', 'sap-agent-executor-patterns','dassian-labor-costing-alc', 'govcon-timekeeping-compliance', 'sap-cats-time-recording', 'vibe-sap-recipes', 'sap-rap-development', 'govcon-dcaa-audit-readiness'], sort: 10 },
